...
include'adicionar_gestor.php';

$pendente=array();
$aux=0;

//verificar os imoveis pendentes para destaque
$file=fopen("../data/$fileimoveis", "r");
  while (!feof($file)) {
  $notificacao=fgetcsv($file,0,";");
  if ($notificacao[2]=="pendente") {
    $file_imovel=fopen("../imoveis/$notificacao[0]/$notificacao[0]imovel.csv","r");
    $pendente[$aux]=fgetcsv($file_imovel,0,";");
    ++$aux;
    fclose($file_imovel);
  }
}
fclose($file);
//verificar imoveis em destaque
$file=fopen("../data/$fileimoveis", "r");
while (!feof($file)) {
  ...
  <body>
    ...
    <div id="Paris" class="tabcontent">
      <div id="notifications">
        <button id="num_notifications"><?php echo count($pendente); ?></button>
        <button id="num_notifications1"><?php echo count($pendente); ?></button>
        <div id="notifications_box">
          ...
          <a href="../p_imovel.php/id=<?php echo $pendente[$i][0]; ?>"><div class="thumbnail_notification">
            <div class="thumb_img_notification">
              <img src="../imoveis/<?php echo $pendente[$i][0]; ?>/<?php echo $pendente[$i][0]; ?>_0.jpg" alt="">
            </div>
